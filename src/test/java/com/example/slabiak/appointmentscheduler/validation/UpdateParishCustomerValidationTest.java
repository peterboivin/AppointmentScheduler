...
public class UpdateParishCustomerValidationTest {
    ...
    @Test
    public void shouldHave10ViolationsForEmptyFormWhenUpdateParishCustomer() {
        UserForm form = new UserForm();
        Set<ConstraintViolation<UserForm>> violations = validator.validate(form, UpdateUser.class, UpdateParishCustomer.class);
