...
public class DayPlan {
    ...
    private List<TimePeriod> timePeriodsWithBreaksExcluded;
    ...
    public void setTimePeriodsWithBreaksExcluded(List<TimePeriod> timePeriodsWithBreaksExcluded) {
        this.timePeriodsWithBreaksExcluded = timePeriodsWithBreaksExcluded;
    }
}
